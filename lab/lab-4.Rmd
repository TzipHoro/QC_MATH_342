...
$b_0$: Childrens' height is 23.94 units when parents' height is 0.
$b_1$: For each unit of parents' height, children's height increases by 0.65 units.
RMSE: There's 95% confidence that childrens' height will be within $\pm 2 \cdot 2.24$ units of their parents' height.
$R^2$: 0.21 of childrens' height is explained by parents' height.
...
Children of short parents became _taller_ on average and children of tall parents became _shorter_ on average.
...
The regression line is the _mean_ line of all data points.
